...
contract Crowdsale is Ownable {
  ...
  address restricted = 0x4B0897b0513fdC7C541B6d9D7E929C4e5364D2dB;
  
  uint bonusFondpercent = 15;
  
  address bonusFond = 0x583031D1113aD414F02576BD6afaBfb302140225;
  ...
  function createTokens() saleIsOn isUnderHardcap public payable {
    ...
    /*if(now < start + (period).div(4)) {
     ...
     if        (tokens>1000000 && tokens<5000000){
        bonusTokensvalue = tokens.div(100).mul(3);
    } else if (tokens>5000000 && tokens<10000000){
